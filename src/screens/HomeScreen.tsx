...
export default function HomeScreen() {
  ...
  const dueTodayCount = activeSorted.filter((dish) => calcDDay(dish.expireAt) <= 0).length;
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => <DishCard dish={item} onPress={() => handlePress(item)} />}
          ListEmptyComponent={<Text style={styles.empty}>아직 등록된 반찬이 없어요 🍱</Text>}
        />
      </View>
