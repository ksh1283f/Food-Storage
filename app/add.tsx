...
import { DishCategory, StorageType } from "@/src/types";
import { CATEGORIES, getRecommendedDays } from "@/src/utils/categoryRules";
import { calcExpireAt } from "@/src/utils/date";
...
const styles = StyleSheet.create({
  ...
  label: { ...TYPO.body, color: COLORS.subText, marginBottom: SPACING.sm, marginTop: SPACING.md },
  input: {
    borderWidth: 1,
    borderColor: "#E3E5E8",
    borderRadius: 12,
